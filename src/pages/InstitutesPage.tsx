      ...
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-accent text-sm font-semibold uppercase tracking-wider">
            {c("institutes_page_label", "Especialidades")}
          </span>
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">
            {c("institutes_page_title", "Nossos Institutos")}
          </h1>
          <p className="text-muted-foreground max-w-xl mx-auto">
            {c("institutes_page_subtitle", "O Grupo Unique reúne institutos especializados para oferecer o cuidado completo que você merece.")}
          </p>
        </motion.div>
        ...
        >
          <p className="text-muted-foreground mb-4">
            {c("institutes_page_cta_text", "Não sabe qual especialidade procurar?")}
          </p>
          <a href={getWhatsAppLink(c("institutes_page_cta_message", "Olá! Gostaria de ajuda para saber qual especialidade procurar."))}>
            <Button className="hero-gradient border-0 text-primary-foreground rounded-full px-8 group">
              ...
              {c("institutes_page_cta_button", "Fale conosco pelo WhatsApp")}
            </Button>
          </a>
        </motion.div>
      </div>
